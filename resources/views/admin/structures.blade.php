...
@section('page-title', 'Gestion des structures')
...
<a href="/admin/structures" class="active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg> Structures</a>
...
@section('content')
<div style="font-size:.85rem;color:#757575;margin-bottom:16px;">{{ $structures->total() }} structure(s)</div>
<div style="background:white;border:1px solid #EEE;border-radius:14px;overflow:hidden;">
    <table style="width:100%;border-collapse:collapse;font-size:.82rem;">
        ...
        <tr style="border-bottom:1px solid #F5F5F5;">
            ...
            <td style="padding:12px 16px;color:#757575;">{{ $s->city?->name_fr }}</td>
            <td style="padding:12px 16px;">@foreach($s->structureTypes as $t)<span style="padding:2px 8px;background:#E8F5E9;color:#2E7D32;border-radius:100px;font-size:.68rem;margin-right:4px;">{{ $t->name_fr }}</span>@endforeach</td>
...
<div style="margin-top:16px;">{{ $structures->links() }}</div>
@endsection
