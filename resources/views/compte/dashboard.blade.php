...
<div class="dash-quick-grid">
    <a href="/compte/pharmacies" class="dash-quick-item">
    ...
    <a href="/compte/urgences" class="dash-quick-item">
        <div class="dash-quick-icon">
